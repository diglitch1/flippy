...
1. Drop in a video (`.mp4`, `.mov`, or `.webm`, up to about 1 minute works best).
...
3. Generate. You get a PDF with an instructions page (including a 5 cm ruler to verify
...
- **About 216 gsm cardstock** flips best. A stapler handles roughly 20 to 25 cards; for more,
  use padding glue, a binder clip, or screw posts (and a slightly wider staple margin).
