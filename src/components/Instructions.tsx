...
export function Instructions({ bindingSide }: Props) {
  return (
    <div className="instructions">
      ...
      <ol>
        <li>
          Print on cardstock (~80&nbsp;lb / 216&nbsp;gsm flips best). In the print dialog choose{' '}
          <strong>Actual size / 100%</strong> — not “Fit to page”.
        </li>
        <li>Cut out every card along the light gray guide lines.</li>
        <li>Stack the cards in order — number&nbsp;1 on top.</li>
      ...
      <p className="instructions__note">
        The PDF’s first page repeats these steps and includes a 1-inch ruler so you can confirm
        your printer isn’t scaling.
      </p>
    </div>
  );
}
